...
const [momentOneScore, setMomentOneScore] = useState(localStorage.momentOneScore ? localStorage.momentOneScore : 0);
const [momentTwo, setMomentTwo] = useState(localStorage.momentTwo ? localStorage.momentTwo : "");
const [momentTwoScore, setMomentTwoScore] = useState(localStorage.momentTwoScore ? localStorage.momentTwoScore : 0);
const [momentThree, setMomentThree] = useState(localStorage.momentThree ? localStorage.momentThree : "");
const [momentThreeScore, setMomentThreeScore] = useState(localStorage.momentThreeScore ? localStorage.momentThreeScore : 0);
const [momentFour, setMomentFour] = useState(localStorage.momentFour ? localStorage.momentFour : "");
const [momentFourScore, setMomentFourScore] = useState(localStorage.momentFourScore ? localStorage.momentFourScore : 0);
const [momentFive, setMomentFive] = useState(localStorage.momentFive ? localStorage.momentFive : "");
const [momentFiveScore, setMomentFiveScore] = useState(localStorage.momentFiveScore ? localStorage.momentFiveScore : 0);
...
<Button className="submitDayContainer" type="submit">
  Log Day in the Diary
    ...
    <motion.div
      ...
      <div className="questionTitleButtonsDisplay">
      {momentOneScore == 0 ? <h5>Moment One is {localStorage.momentOne}</h5> :   <h5>Moment One is {localStorage.momentOne} - {localStorage.momentOneScore}/10</h5>}
...
<motion.div
  ...
  variants={showHideMomentState}>
  <div className="questionTitleButtonsDisplay">
    {momentTwoScore == 0 ? <h5>Moment Two is {localStorage.momentTwo}</h5> :   <h5>Moment Two is {localStorage.momentTwo} - {localStorage.momentTwoScore}/10</h5>}
  <div className="editDelete">
    <FontAwesomeIcon
      className="editIcon"
      icon={faPenToSquare}
